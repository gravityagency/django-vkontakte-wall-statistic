...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostReach'
        db.create_table(u'vkontakte_wall_statistic_postreach', (
            ('fetched', self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True)),
            ('post', self.gf('django.db.models.fields.related.OneToOneField')(related_name='reach', unique=True, primary_key=True, to=orm['vkontakte_wall.Post'])),
            ('hide', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('join_group', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('links', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('reach_subscribers', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('reach_total', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('report', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('to_group', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('unsubscribe', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'vkontakte_wall_statistic', ['PostReach'])


    def backwards(self, orm):
        # Deleting model 'PostReach'
        db.delete_table(u'vkontakte_wall_statistic_postreach')
    ...
    models = {
        ...
        u'vkontakte_wall_statistic.postreach': {
            'Meta': {'object_name': 'PostReach'},
            'fetched': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'hide': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'join_group': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'links': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'post': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'reach'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['vkontakte_wall.Post']"}),
            'reach_subscribers': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'reach_total': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'report': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'to_group': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'unsubscribe': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
